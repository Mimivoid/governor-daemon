...
int main() {
	...
	int ncpus = hwloc_bitmap_weight(hwloc_topology_get_complete_cpuset(topology));

	printf("%d\n", ncpus);

	const long tick_ms = 480; // ~1/2 Hz @ 512
